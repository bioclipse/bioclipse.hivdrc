 ...
 * <ul>
 *   <li>{@link org.hivdrc.hivpred.impl.ResultTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.ResultTypeImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResultTypeImpl extends EObjectImpl implements ResultType {
	...
	protected EClass eStaticClass() {
		return HivpredPackage.Literals.RESULT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HivpredPackage.RESULT_TYPE__NAME, oldName, name));
	}
	...
	public void setResult(double newResult) {
		...
		resultESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HivpredPackage.RESULT_TYPE__RESULT, oldResult, result, !oldResultESet));
	}
	...
	public void unsetResult() {
		...
		resultESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, HivpredPackage.RESULT_TYPE__RESULT, oldResult, RESULT_EDEFAULT, oldResultESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HivpredPackage.RESULT_TYPE__NAME:
				return getName();
			case HivpredPackage.RESULT_TYPE__RESULT:
