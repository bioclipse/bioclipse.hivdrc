...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>HIV Pred Output Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getMutNotInDataset <em>Mut Not In Dataset</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getMutOutsideModelBoundaries <em>Mut Outside Model Boundaries</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getMutPlusMutOutsideModelBoundaries <em>Mut Plus Mut Outside Model Boundaries</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getMutPlusWtOutsideModelBoundaries <em>Mut Plus Wt Outside Model Boundaries</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getErrorMessage <em>Error Message</em>}</li>
 *   <li>{@link org.hivdrc.hivpred.impl.HIVPredOutputTypeImpl#getWarningMessage <em>Warning Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HIVPredOutputTypeImpl extends EObjectImpl implements HIVPredOutputType {
	/**
	 ...
	 * @generated
	 */
	protected HIVPredOutputTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return HivpredPackage.Literals.HIV_PRED_OUTPUT_TYPE;
	}
	...
	public EList<MutNotInDatasetType> getMutNotInDataset() {
		if (mutNotInDataset == null) {
			mutNotInDataset = new EObjectContainmentEList<MutNotInDatasetType>(MutNotInDatasetType.class, this, HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_NOT_IN_DATASET);
		}
	...
	public EList<MutOutsideModelBoundariesType> getMutOutsideModelBoundaries() {
		if (mutOutsideModelBoundaries == null) {
			mutOutsideModelBoundaries = new EObjectContainmentEList<MutOutsideModelBoundariesType>(MutOutsideModelBoundariesType.class, this, HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_OUTSIDE_MODEL_BOUNDARIES);
		}
	...
	public EList<MutPlusMutOutsideModelBoundariesType> getMutPlusMutOutsideModelBoundaries() {
		if (mutPlusMutOutsideModelBoundaries == null) {
			mutPlusMutOutsideModelBoundaries = new EObjectContainmentEList<MutPlusMutOutsideModelBoundariesType>(MutPlusMutOutsideModelBoundariesType.class, this, HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_PLUS_MUT_OUTSIDE_MODEL_BOUNDARIES);
		}
	...
	public EList<MutPlusWtOutsideModelBoundariesType> getMutPlusWtOutsideModelBoundaries() {
		if (mutPlusWtOutsideModelBoundaries == null) {
			mutPlusWtOutsideModelBoundaries = new EObjectContainmentEList<MutPlusWtOutsideModelBoundariesType>(MutPlusWtOutsideModelBoundariesType.class, this, HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_PLUS_WT_OUTSIDE_MODEL_BOUNDARIES);
		}
	...
	public EList<ResultType> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<ResultType>(ResultType.class, this, HivpredPackage.HIV_PRED_OUTPUT_TYPE__RESULT);
		}
		return result;
	}
	...
	public void setErrorMessage(String newErrorMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HivpredPackage.HIV_PRED_OUTPUT_TYPE__ERROR_MESSAGE, oldErrorMessage, errorMessage));
	}
	...
	public void setWarningMessage(String newWarningMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HivpredPackage.HIV_PRED_OUTPUT_TYPE__WARNING_MESSAGE, oldWarningMessage, warningMessage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_NOT_IN_DATASET:
				return ((InternalEList<?>)getMutNotInDataset()).basicRemove(otherEnd, msgs);
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_OUTSIDE_MODEL_BOUNDARIES:
				return ((InternalEList<?>)getMutOutsideModelBoundaries()).basicRemove(otherEnd, msgs);
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_PLUS_MUT_OUTSIDE_MODEL_BOUNDARIES:
				return ((InternalEList<?>)getMutPlusMutOutsideModelBoundaries()).basicRemove(otherEnd, msgs);
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__MUT_PLUS_WT_OUTSIDE_MODEL_BOUNDARIES:
				return ((InternalEList<?>)getMutPlusWtOutsideModelBoundaries()).basicRemove(otherEnd, msgs);
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__RESULT:
				return getResult();
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__ERROR_MESSAGE:
				return getErrorMessage();
			case HivpredPackage.HIV_PRED_OUTPUT_TYPE__WARNING_MESSAGE:
